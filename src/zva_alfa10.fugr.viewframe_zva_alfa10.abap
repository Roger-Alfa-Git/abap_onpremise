*---------------------------------------------------------------------*
*    program for:   VIEWFRAME_ZVA_ALFA10
*---------------------------------------------------------------------*
FUNCTION VIEWFRAME_ZVA_ALFA10          .
...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZVA_ALFA10'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZVA_ALFA10_EXTRACT
TOTAL = ZVA_ALFA10_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZVA_ALFA10'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZVA_ALFA10-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZVA_ALFA10_EXTRACT
TOTAL = ZVA_ALFA10_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZVA_ALFA10-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZVA_ALFA10'
...
TOTAL = ZVA_ALFA10_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZVA_ALFA10-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZVA_ALFA10-UPD_FLAG NE SPACE.
