*&---------------------------------------------------------------------*
*& Report ZPOO_T11_EJERCICIO6_ALFA10
*&---------------------------------------------------------------------*
*&
*&---------------------------------------------------------------------*
REPORT zpoo_t11_ejercicio6_alfa10.
...
FIELD-SYMBOLS <gs_ekpo> TYPE ekpo.

TRY.
    gr_area = zcl_cesta_comp_area_alfa10=>attach_for_update(
*                client      =
...
READ TABLE gr_area->root->doc_compras ASSIGNING <gs_ekpo> INDEX 1.

<gs_ekpo>-ebeln = '0123456789'.
