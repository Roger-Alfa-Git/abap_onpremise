class ZCB_PERSIST_ESTUD_ALFA10 definition
  public
...
public section.
  ...
  methods CREATE_PERSISTENT
    importing
      !I_ESTUDIANTE type SYUNAME
    returning
      value(RESULT) type ref to ZCL_PERSIST_ESTUD_ALFA10
    raising
...
protected section.
  ...
  types TYP_OBJECT_REF type ref to ZCL_PERSIST_ESTUD_ALFA10 .
  types:
    begin of TYP_BUSINESS_KEY ,
      ESTUDIANTE type SYUNAME ,
...
CLASS ZCB_PERSIST_ESTUD_ALFA10 IMPLEMENTATION.
...
************************************************************************
  ...
  data: NEW_OBJECT type ref to ZCL_PERSIST_ESTUD_ALFA10.

* * 1. Create object and set BKey attributes
  create object NEW_OBJECT.

* < Generated from mapping:
  NEW_OBJECT->ESTUDIANTE = I_BUSINESS_KEY-ESTUDIANTE.
* >
...
************************************************************************
  ...
  data: THE_OBJECT type ref to ZCL_PERSIST_ESTUD_ALFA10,
...
*<  Generated from mapping:
  THE_OBJECT->ESTUDIANTE = I_OBJECT_DATA-ESTUDIANTE.
  THE_OBJECT->NOMBRE = I_OBJECT_DATA-NOMBRE.
  THE_OBJECT->FECHA_NACIMIENTO = I_OBJECT_DATA-FECHA_NACIMIENTO.
*>
...
*< Generated from mapping:
  COMP_STRING = I_BUSINESS_KEY-ESTUDIANTE.
...
* * ZESTUD_ALFA10: internal tables for mass operation
  data DB_ITB_ZESTUD_ALFA10 type STANDARD TABLE OF ZESTUD_ALFA10.
  data DB_UTB_ZESTUD_ALFA10 type STANDARD TABLE OF ZESTUD_ALFA10.
  data DB_DTB_ZESTUD_ALFA10 type STANDARD TABLE OF ZESTUD_ALFA10.

* * ZESTUD_ALFA10: headlines for tables
  data DB_ILN_ZESTUD_ALFA10 type ZESTUD_ALFA10.
  data DB_ULN_ZESTUD_ALFA10 type ZESTUD_ALFA10.
  data DB_DLN_ZESTUD_ALFA10 type ZESTUD_ALFA10.
...
*< Generated from mapping:
   ...
   DB_ILN_ZESTUD_ALFA10-NOMBRE = <FS_INSERT>-NOMBRE.
   DB_ILN_ZESTUD_ALFA10-FECHA_NACIMIENTO = <FS_INSERT>-FECHA_NACIMIENTO.


   DB_ILN_ZESTUD_ALFA10-ESTUDIANTE = <FS_INSERT>-ESTUDIANTE.
   append DB_ILN_ZESTUD_ALFA10 to DB_ITB_ZESTUD_ALFA10.
*>
...
*< Generated from mapping:
   ...
   DB_ULN_ZESTUD_ALFA10-NOMBRE = <FS_UPDATE>-NOMBRE.
   DB_ULN_ZESTUD_ALFA10-FECHA_NACIMIENTO = <FS_UPDATE>-FECHA_NACIMIENTO.


   DB_ULN_ZESTUD_ALFA10-ESTUDIANTE = <FS_UPDATE>-ESTUDIANTE.
   append DB_ULN_ZESTUD_ALFA10 TO DB_UTB_ZESTUD_ALFA10.
*>
...
* * Collect Deletes
  loop at I_DELETES assigning <FS_DELETE>.
    ...
    DB_DLN_ZESTUD_ALFA10-ESTUDIANTE =
    <FS_DELETE>-BUSINESS_KEY-ESTUDIANTE.

    append DB_DLN_ZESTUD_ALFA10 TO DB_DTB_ZESTUD_ALFA10.
...
* * DB Deletes
  delete ZESTUD_ALFA10 FROM TABLE DB_DTB_ZESTUD_ALFA10.
  if SY-SUBRC <> 0.
...
* * DB Inserts
  insert ZESTUD_ALFA10 FROM TABLE DB_ITB_ZESTUD_ALFA10
...
* * DB Updates
  update ZESTUD_ALFA10 FROM TABLE DB_UTB_ZESTUD_ALFA10.
  if SY-SUBRC <> 0.
...
*<  Generated from mapping:
    <FS_OBJECT_DATA>-ESTUDIANTE = BUSINESS_KEY-ESTUDIANTE.
*>
...
*< Generated from mapping:
  types: TYP_DB_DATA_LOCAL type ZESTUD_ALFA10.
*>
...
*< Generated from mapping:
  field-symbols: <FS_DB_ZESTUD_ALFA10> type ZESTUD_ALFA10.
*>

*< Generated from mapping:
  select * from ZESTUD_ALFA10
           into table DB_DATA_LOCAL_TAB
           for all entries in I_BUSINESS_KEY_TAB
           where ZESTUD_ALFA10~ESTUDIANTE =
           I_BUSINESS_KEY_TAB-ESTUDIANTE.
*>
...
* * error handling
  if ( SY-SUBRC <> 0 ).
    ...
    raise exception type CX_OS_DB_SELECT
         exporting TABLE  = 'ZESTUD_ALFA10'
                   TEXTID = CX_OS_DB_SELECT=>BY_BKEYTAB.
  endif. "( Error )

  loop at DB_DATA_LOCAL_TAB assigning <FS_DB_DATA_LOCAL>.

    assign <FS_DB_DATA_LOCAL> to <FS_DB_ZESTUD_ALFA10>.

*< Generated from mapping:
    DB_DATA-ESTUDIANTE = <FS_DB_ZESTUD_ALFA10>-ESTUDIANTE.
    DB_DATA-NOMBRE = <FS_DB_ZESTUD_ALFA10>-NOMBRE.
    DB_DATA-FECHA_NACIMIENTO = <FS_DB_ZESTUD_ALFA10>-FECHA_NACIMIENTO.
*>
...
************************************************************************
  ...
  data: OBJECT_IREF type TYP_OBJECT_IREF,
        THE_OBJECT  type ref TO ZCL_PERSIST_ESTUD_ALFA10.
...
*<    Generated from Mapping:
      clear: THE_OBJECT->ESTUDIANTE,
             THE_OBJECT->NOMBRE,
             THE_OBJECT->FECHA_NACIMIENTO.
*>
...
*<  Generated from mapping:
    OBJECT_DATA_ITEM-ESTUDIANTE = THE_OBJECT->ESTUDIANTE.
    OBJECT_DATA_ITEM-NOMBRE = THE_OBJECT->NOMBRE.
    OBJECT_DATA_ITEM-FECHA_NACIMIENTO = THE_OBJECT->FECHA_NACIMIENTO.
*>
...
*<Generated from mapping:
  E_BUSINESS_KEY-ESTUDIANTE  = I_DB_DATA-ESTUDIANTE.
*>
...
*< Generated from mapping:
  call method CREATE_TRANSIENT
       exporting I_ESTUDIANTE = BUSINESS_KEY-ESTUDIANTE
...
***BUILD 093901
*      IMPORTING I_ESTUDIANTE TYPE SYUNAME.
*      RETURNING RESULT TYPE REF TO ZCL_PERSIST_ESTUD_ALFA10
*       raising   CX_OS_OBJECT_NOT_FOUND
************************************************************************
...
*< Generated from mapping:
  BUSINESS_KEY-ESTUDIANTE = I_ESTUDIANTE.
*>
...
*<  Generated from mapping:
          THE_OBJECT->ESTUDIANTE = I_ESTUDIANTE.
*>
