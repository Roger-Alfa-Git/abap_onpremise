class ZCB_PEDIDOS_ALFA10 definition
  public
...
public section.
  ...
  methods CREATE_PERSISTENT
    ...
    returning
      value(RESULT) type ref to ZCL_PEDIDOS_ALFA10
    raising
...
protected section.
  ...
  types TYP_OBJECT_REF type ref to ZCL_PEDIDOS_ALFA10 .
  types:
...
CLASS ZCB_PEDIDOS_ALFA10 IMPLEMENTATION.
...
************************************************************************
  ...
  data: NEW_OBJECT type ref to ZCL_PEDIDOS_ALFA10.
...
************************************************************************
  ...
  data: THE_OBJECT type ref to ZCL_PEDIDOS_ALFA10,
...
*<  Generated from mapping:
  ...
  THE_OBJECT->ERDAT = I_OBJECT_DATA-ERDAT.
  THE_OBJECT->ERZET = I_OBJECT_DATA-ERZET.
  THE_OBJECT->ERNAM = I_OBJECT_DATA-ERNAM.
*>
...
* * ZPE_ALFA10: internal tables for mass operation
  data DB_ITB_ZPE_ALFA10 type STANDARD TABLE OF ZPE_ALFA10.
  data DB_UTB_ZPE_ALFA10 type STANDARD TABLE OF ZPE_ALFA10.
  data DB_DTB_ZPE_ALFA10 type STANDARD TABLE OF ZPE_ALFA10.

* * ZPE_ALFA10: headlines for tables
  data DB_ILN_ZPE_ALFA10 type ZPE_ALFA10.
  data DB_ULN_ZPE_ALFA10 type ZPE_ALFA10.
  data DB_DLN_ZPE_ALFA10 type ZPE_ALFA10.
...
*< Generated from mapping:
   ...
   DB_ILN_ZPE_ALFA10-ERDAT = <FS_INSERT>-ERDAT.
   DB_ILN_ZPE_ALFA10-ERZET = <FS_INSERT>-ERZET.
   DB_ILN_ZPE_ALFA10-ERNAM = <FS_INSERT>-ERNAM.


   DB_ILN_ZPE_ALFA10-VBELN = <FS_INSERT>-VBELN.
   append DB_ILN_ZPE_ALFA10 to DB_ITB_ZPE_ALFA10.
*>
...
*< Generated from mapping:
   ...
   DB_ULN_ZPE_ALFA10-ERDAT = <FS_UPDATE>-ERDAT.
   DB_ULN_ZPE_ALFA10-ERZET = <FS_UPDATE>-ERZET.
   DB_ULN_ZPE_ALFA10-ERNAM = <FS_UPDATE>-ERNAM.


   DB_ULN_ZPE_ALFA10-VBELN = <FS_UPDATE>-VBELN.
   append DB_ULN_ZPE_ALFA10 TO DB_UTB_ZPE_ALFA10.
*>
...
* * Collect Deletes
  loop at I_DELETES assigning <FS_DELETE>.
    ...
    DB_DLN_ZPE_ALFA10-VBELN = <FS_DELETE>-BUSINESS_KEY-VBELN.

    append DB_DLN_ZPE_ALFA10 TO DB_DTB_ZPE_ALFA10.
...
* * DB Deletes
  delete ZPE_ALFA10 FROM TABLE DB_DTB_ZPE_ALFA10.
  if SY-SUBRC <> 0.
...
* * DB Inserts
  insert ZPE_ALFA10 FROM TABLE DB_ITB_ZPE_ALFA10
...
* * DB Updates
  update ZPE_ALFA10 FROM TABLE DB_UTB_ZPE_ALFA10.
  if SY-SUBRC <> 0.
...
*< Generated from mapping:
  types: TYP_DB_DATA_LOCAL type ZPE_ALFA10.
*>
...
*< Generated from mapping:
  field-symbols: <FS_DB_ZPE_ALFA10> type ZPE_ALFA10.
*>

*< Generated from mapping:
  select * from ZPE_ALFA10
           into table DB_DATA_LOCAL_TAB
           for all entries in I_BUSINESS_KEY_TAB
           where ZPE_ALFA10~VBELN = I_BUSINESS_KEY_TAB-VBELN.
*>
...
* * error handling
  if ( SY-SUBRC <> 0 ).
    ...
    raise exception type CX_OS_DB_SELECT
         exporting TABLE  = 'ZPE_ALFA10'
                   TEXTID = CX_OS_DB_SELECT=>BY_BKEYTAB.
  endif. "( Error )

  loop at DB_DATA_LOCAL_TAB assigning <FS_DB_DATA_LOCAL>.

    assign <FS_DB_DATA_LOCAL> to <FS_DB_ZPE_ALFA10>.

*< Generated from mapping:
    DB_DATA-VBELN = <FS_DB_ZPE_ALFA10>-VBELN.
    DB_DATA-ERDAT = <FS_DB_ZPE_ALFA10>-ERDAT.
    DB_DATA-ERZET = <FS_DB_ZPE_ALFA10>-ERZET.
    DB_DATA-ERNAM = <FS_DB_ZPE_ALFA10>-ERNAM.
*>
...
************************************************************************
  ...
  data: OBJECT_IREF type TYP_OBJECT_IREF,
        THE_OBJECT  type ref TO ZCL_PEDIDOS_ALFA10.
...
*<  Generated from mapping:
    ...
    OBJECT_DATA_ITEM-ERDAT = THE_OBJECT->ERDAT.
    OBJECT_DATA_ITEM-ERZET = THE_OBJECT->ERZET.
    OBJECT_DATA_ITEM-ERNAM = THE_OBJECT->ERNAM.
*>
...
*< Generated from mapping:
  call method CREATE_TRANSIENT
       exporting I_VBELN = BUSINESS_KEY-VBELN
...
*      RETURNING RESULT TYPE REF TO ZCL_PEDIDOS_ALFA10
*       raising   CX_OS_OBJECT_NOT_FOUND
************************************************************************
