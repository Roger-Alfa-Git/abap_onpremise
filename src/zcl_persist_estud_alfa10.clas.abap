class ZCL_PERSIST_ESTUD_ALFA10 definition
  public
  create protected

  global friends ZCB_PERSIST_ESTUD_ALFA10 .

public section.

  interfaces IF_OS_STATE .

  methods GET_ESTUDIANTE
    returning
      value(RESULT) type SYUNAME
    raising
      CX_OS_OBJECT_NOT_FOUND .
  methods GET_FECHA_NACIMIENTO
    returning
  ...
  methods GET_NOMBRE
    ...
    raising
      CX_OS_OBJECT_NOT_FOUND .
  methods SET_FECHA_NACIMIENTO
    importing
      !I_FECHA_NACIMIENTO type DATUM
    raising
      CX_OS_OBJECT_NOT_FOUND .
  methods SET_NOMBRE
    importing
...
protected section.
  ...
  data ESTUDIANTE type SYUNAME .
  data NOMBRE type NAME .
  data FECHA_NACIMIENTO type DATUM .
private section.
ENDCLASS.



CLASS ZCL_PERSIST_ESTUD_ALFA10 IMPLEMENTATION.


  method GET_ESTUDIANTE.
***BUILD 090501
     " returning RESULT
     " raising CX_OS_OBJECT_NOT_FOUND
************************************************************************
* Purpose        : Get Attribute ESTUDIANTE
*
* Version        : 2.0
*
* Precondition   : -
...
* * Inform class agent and handle exceptions
  ...
  method GET_FECHA_NACIMIENTO.
***BUILD 090501
     " returning RESULT
     " raising CX_OS_OBJECT_NOT_FOUND
************************************************************************
* Purpose        : Get Attribute FECHA_NACIMIENTO
*
* Version        : 2.0
*
* Precondition   : -
...
***BUILD 090501
     " importing I_FECHA_NACIMIENTO
     " raising CX_OS_OBJECT_NOT_FOUND
************************************************************************
* Purpose        : Set attribute FECHA_NACIMIENTO
*
* Version        : 2.0
*
* Precondition   : -
...
* * Inform class agent and handle exceptions
  ...
  if ( I_FECHA_NACIMIENTO <> FECHA_NACIMIENTO ).
...
*   * Inform class agent and handle exceptions
  ...
  endif. "( I_FECHA_NACIMIENTO <> FECHA_NACIMIENTO )
