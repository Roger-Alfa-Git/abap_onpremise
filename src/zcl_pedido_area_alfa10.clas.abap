class ZCL_PEDIDO_AREA_ALFA10 definition
  public
...
public section.
  ...
  constants AREA_NAME type SHM_AREA_NAME value 'ZCL_PEDIDO_AREA_ALFA10' ##NO_TEXT.
  data ROOT type ref to ZCL_PEDIDO_ALFA10 read-only .
  ...
  class-methods ATTACH_FOR_READ
    ...
    returning
      value(HANDLE) type ref to ZCL_PEDIDO_AREA_ALFA10
    raising
      CX_SHM_INCONSISTENT
  ...
  methods SET_ROOT
    importing
      !ROOT type ref to ZCL_PEDIDO_ALFA10
    raising
...
CLASS ZCL_PEDIDO_AREA_ALFA10 IMPLEMENTATION.
